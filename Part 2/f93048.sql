...
,p_default_application_id=>93048
...
prompt APPLICATION 93048 - F15 Mobile Rest App
--
-- Application Export:
--   Application:     93048
...
,p_display_id=>nvl(wwv_flow_application_install.get_application_id,93048)
...
,p_alias=>nvl(wwv_flow_application_install.get_application_alias,'F_93048')
,p_page_view_logging=>'YES'
,p_page_protection_enabled_y_n=>'Y'
,p_checksum_salt=>'375856DC6736F66DBAE64C01F8CF15DAE43C99E3FD1F2CA725D7442CD34168E2'
...
,p_authentication_id=>wwv_flow_api.id(15203957686132300647)
...
wwv_flow_api.create_list(
 p_id=>wwv_flow_api.id(15203948732337300635)
,p_name=>'Mobile Navigation Menu'
,p_list_status=>'PUBLIC'
);
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(15203958588876300649)
...
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(15203948406306300635)
...
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(15203948540442300635)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_CSS_CALENDAR'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(15203948659978300635)
,p_plugin_type=>'REGION TYPE'
...
wwv_flow_api.create_icon_bar_item(
 p_id=>wwv_flow_api.id(15203957502187300647)
,p_icon_sequence=>200
...
wwv_flow_api.create_menu(
 p_id=>wwv_flow_api.id(15203957732679300647)
,p_name=>' Breadcrumb'
);
end;
/
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(15203948856056300636)
,p_theme_id=>51
,p_name=>'Dialog'
,p_is_popup=>true
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(15203949049133300637)
,p_theme_id=>51
,p_name=>'Page'
,p_is_popup=>false
,p_header_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(15203949122581300637)
,p_page_template_id=>wwv_flow_api.id(15203949049133300637)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(15203949293051300637)
,p_page_template_id=>wwv_flow_api.id(15203949049133300637)
,p_name=>'Footer Bar'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(15203949374599300637)
,p_page_template_id=>wwv_flow_api.id(15203949049133300637)
,p_name=>'Header Bar'
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(15203949800265300638)
,p_theme_id=>51
,p_name=>'Popup'
,p_is_popup=>false
,p_header_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(15203952264313300641)
...
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(15203956443903300644)
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(15203949999774300638)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(15203950002296300638)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(15203950171385300638)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(15203950242376300638)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(15203950346617300638)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(15203950414481300638)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(15203950572303300639)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(15203950637170300639)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(15203950710001300639)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(15203950848222300639)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(15203950991252300639)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(15203951031811300639)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(15203951123868300639)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(15203951255565300640)
,p_layout=>'TABLE'
,p_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(15203951401396300640)
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(15203951582530300640)
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(15203951695946300640)
,p_list_template_current=>'<li data-theme="b"><a href="#LINK#">#TEXT_ESC_SC#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT_ESC_SC#</a></li>'
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(15203951730978300640)
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(15203951856776300640)
,p_list_template_current=>'<li data-theme="b"><a href="#LINK#">#TEXT_ESC_SC#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT_ESC_SC#</a></li>'
...
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(15203951371483300640)
...
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(15203951900813300641)
...
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(15203952069119300641)
...
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(15203952154164300641)
...
wwv_flow_api.create_popup_lov_template(
 p_id=>wwv_flow_api.id(15203956835046300644)
...
wwv_flow_api.create_calendar_template(
 p_id=>wwv_flow_api.id(15203956785070300644)
...
wwv_flow_api.create_theme(
 p_id=>wwv_flow_api.id(15203957384498300646)
,p_theme_id=>51
,p_theme_name=>'Mobile'
...
,p_is_locked=>false
,p_default_page_template=>wwv_flow_api.id(15203949049133300637)
,p_default_dialog_template=>wwv_flow_api.id(15203948856056300636)
,p_error_template=>wwv_flow_api.id(15203949049133300637)
,p_printer_friendly_template=>wwv_flow_api.id(15203949049133300637)
,p_login_template=>wwv_flow_api.id(15203949049133300637)
,p_default_button_template=>wwv_flow_api.id(15203956443903300644)
,p_default_region_template=>wwv_flow_api.id(15203951031811300639)
,p_default_chart_template=>wwv_flow_api.id(15203951031811300639)
,p_default_form_template=>wwv_flow_api.id(15203951031811300639)
,p_default_reportr_template=>wwv_flow_api.id(15203951255565300640)
,p_default_tabform_template=>wwv_flow_api.id(15203951031811300639)
,p_default_wizard_template=>wwv_flow_api.id(15203951031811300639)
,p_default_irr_template=>wwv_flow_api.id(15203951031811300639)
,p_default_report_template=>wwv_flow_api.id(15203951371483300640)
,p_default_label_template=>wwv_flow_api.id(15203952069119300641)
,p_default_calendar_template=>wwv_flow_api.id(15203956785070300644)
,p_default_list_template=>wwv_flow_api.id(15203951695946300640)
,p_default_nav_list_template=>wwv_flow_api.id(15203951582530300640)
,p_default_top_nav_list_temp=>wwv_flow_api.id(15203951582530300640)
,p_default_side_nav_list_temp=>wwv_flow_api.id(15203951856776300640)
,p_default_nav_list_position=>'SIDE'
,p_default_dialogbtnr_template=>wwv_flow_api.id(15203949999774300638)
,p_default_dialogr_template=>wwv_flow_api.id(15203951031811300639)
,p_default_option_label=>wwv_flow_api.id(15203952069119300641)
,p_default_header_template=>wwv_flow_api.id(15203950710001300639)
,p_default_footer_template=>wwv_flow_api.id(15203950572303300639)
,p_default_required_label=>wwv_flow_api.id(15203952154164300641)
...
wwv_flow_api.create_theme_style(
 p_id=>wwv_flow_api.id(15203956913434300645)
,p_theme_id=>51
,p_name=>'Blue'
...
wwv_flow_api.create_theme_style(
 p_id=>wwv_flow_api.id(15203957063620300645)
,p_theme_id=>51
,p_name=>'Dark'
,p_css_file_urls=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_theme_style(
 p_id=>wwv_flow_api.id(15203957184871300645)
,p_theme_id=>51
,p_name=>'Default'
...
wwv_flow_api.create_theme_style(
 p_id=>wwv_flow_api.id(15203957220740300645)
,p_theme_id=>51
,p_name=>'Red'
,p_css_file_urls=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(15203949415822300637)
,p_theme_id=>51
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(15203952317270300641)
,p_theme_id=>51
,p_name=>'ICON_BUTTON'
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(15203952847136300641)
,p_theme_id=>51
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15203949519075300637)
,p_theme_id=>51
,p_name=>'OVERLAY'
...
,p_group_id=>wwv_flow_api.id(15203949415822300637)
,p_template_types=>'PAGE'
);
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15203949668348300638)
,p_theme_id=>51
,p_name=>'PUSH'
,p_display_name=>'Push'
,p_display_sequence=>1
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15203949725617300638)
,p_theme_id=>51
,p_name=>'REVEAL'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15203952428639300641)
,p_theme_id=>51
,p_name=>'ICON_ACTION'
,p_display_name=>'Action'
,p_display_sequence=>100
,p_button_template_id=>wwv_flow_api.id(15203952264313300641)
,p_css_classes=>'ui-icon-action'
,p_group_id=>wwv_flow_api.id(15203952317270300641)
,p_template_types=>'BUTTON'
);
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15203952530809300641)
,p_theme_id=>51
,p_name=>'ICON_ALERT'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15203952641899300641)
,p_theme_id=>51
,p_name=>'ICON_BACK'
,p_display_name=>'Back'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15203952731665300641)
,p_theme_id=>51
,p_name=>'ICON_BARS'
,p_display_name=>'Bars'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15203952926832300641)
,p_theme_id=>51
,p_name=>'ICON_BOTTOM'
...
,p_group_id=>wwv_flow_api.id(15203952847136300641)
,p_template_types=>'BUTTON'
);
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15203953070660300641)
,p_theme_id=>51
,p_name=>'ICON_BULLETS'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15203953191812300641)
,p_theme_id=>51
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15203953205029300641)
,p_theme_id=>51
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15203953394525300642)
,p_theme_id=>51
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15203953400799300642)
,p_theme_id=>51
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15203953555102300642)
,p_theme_id=>51
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15203953694929300642)
,p_theme_id=>51
,p_name=>'ICON_CHECK'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15203953734593300642)
,p_theme_id=>51
,p_name=>'ICON_CLOCK'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15203953834490300642)
,p_theme_id=>51
,p_name=>'ICON_CLOUD'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15203953911939300642)
,p_theme_id=>51
,p_name=>'ICON_COMMENT'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15203954000046300642)
,p_theme_id=>51
,p_name=>'ICON_DELETE'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15203954131540300642)
,p_theme_id=>51
,p_name=>'ICON_EDIT'
,p_display_name=>'Edit'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15203954230249300643)
,p_theme_id=>51
,p_name=>'ICON_GEAR'
,p_display_name=>'Gear'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15203954393956300643)
,p_theme_id=>51
,p_name=>'ICON_GRID'
,p_display_name=>'Grid'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15203954460115300643)
,p_theme_id=>51
,p_name=>'ICON_HOME'
,p_display_name=>'Home'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15203954570829300643)
,p_theme_id=>51
,p_name=>'ICON_INFO'
,p_display_name=>'Info'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15203954648159300643)
,p_theme_id=>51
,p_name=>'ICON_LEFT'
,p_display_name=>'Left'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15203954787219300643)
,p_theme_id=>51
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15203954843501300643)
,p_theme_id=>51
,p_name=>'ICON_LOCK'
,p_display_name=>'Lock'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15203954947668300643)
,p_theme_id=>51
,p_name=>'ICON_MAIL'
,p_display_name=>'Mail'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15203955039190300643)
,p_theme_id=>51
,p_name=>'ICON_MINUS'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15203955163666300643)
,p_theme_id=>51
,p_name=>'ICON_PHONE'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15203955209931300643)
,p_theme_id=>51
,p_name=>'ICON_PLUS'
,p_display_name=>'Plus'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15203955347402300643)
,p_theme_id=>51
,p_name=>'ICON_POWER'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15203955406255300643)
,p_theme_id=>51
,p_name=>'ICON_REFRESH'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15203955585190300643)
,p_theme_id=>51
,p_name=>'ICON_RIGHT'
,p_display_name=>'Right'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15203955650898300643)
,p_theme_id=>51
,p_name=>'ICON_SEARCH'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15203955703371300644)
,p_theme_id=>51
,p_name=>'ICON_STAR'
,p_display_name=>'Star'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15203955847552300644)
,p_theme_id=>51
,p_name=>'ICON_TAG'
,p_display_name=>'Tag'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15203955949473300644)
,p_theme_id=>51
,p_name=>'ICON_TOP'
,p_display_name=>'Top'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15203956067580300644)
,p_theme_id=>51
,p_name=>'ICON_USER'
,p_display_name=>'User'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15203956199185300644)
,p_theme_id=>51
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15203956235022300644)
,p_theme_id=>51
,p_name=>'NO_TEXT'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15203956398038300644)
,p_theme_id=>51
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15203956594648300644)
,p_theme_id=>51
,p_name=>'INLINE_BUTTON'
,p_display_name=>'Inline Button'
,p_display_sequence=>1
,p_button_template_id=>wwv_flow_api.id(15203956443903300644)
,p_css_classes=>'ui-btn-inline'
,p_template_types=>'BUTTON'
);
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(15203956674474300644)
,p_theme_id=>51
,p_name=>'ROUNDED_CORNERS'
,p_display_name=>'Rounded Corners'
,p_display_sequence=>1
...
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(15203957686132300647)
...
wwv_flow_api.create_user_interface(
 p_id=>wwv_flow_api.id(15203957450737300646)
,p_ui_type_name=>'JQM_SMARTPHONE'
...
,p_global_page_id=>0
,p_navigation_list_id=>wwv_flow_api.id(15203948732337300635)
,p_navigation_list_position=>'SIDE'
,p_navigation_list_template_id=>wwv_flow_api.id(15203951856776300640)
...
,p_plug_template=>wwv_flow_api.id(15203950710001300639)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(15203958337307300649)
,p_plug_name=>'Footer'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(15203950572303300639)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(15203958282197300648)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(15203958011741300648)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(15203958126243300648)
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(15203958427097300649)
,p_name=>'open panel'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(15203958126243300648)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(15203958427097300649)
,p_event_id=>wwv_flow_api.id(15203958427097300649)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(18008509998986504400)
,p_name=>'Results'
,p_template=>wwv_flow_api.id(15203951255565300640)
,p_display_sequence=>30
,p_include_in_reg_disp_sel_yn=>'N'
,p_region_template_options=>'#DEFAULT#'
...
'where collection_name = ''P1_DOREST_RESULTS'''))
,p_source_type=>'NATIVE_SQL_REPORT'
,p_display_condition_type=>'NEVER'
,p_ajax_enabled=>'N'
,p_query_row_template=>wwv_flow_api.id(15203951371483300640)
,p_query_num_rows=>15
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(18008510640524504407)
,p_query_column_id=>1
...
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(18041777006309080019)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(18041775298358080001)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(18041777006309080019)
,p_button_name=>'Teams'
,p_button_action=>'DEFINED_BY_DA'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(18041776545663080014)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(18008502435802504386)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(18008503219971504389)
,p_name=>'P1_DB'
,p_item_sequence=>1
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(18008504071997504394)
,p_name=>'P1_USER'
,p_item_sequence=>2
,p_item_plug_id=>wwv_flow_api.id(18008501781806504380)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(18008504803133504394)
,p_name=>'P1_PASS'
,p_item_sequence=>3
,p_item_plug_id=>wwv_flow_api.id(18008501781806504380)
,p_item_default=>'orcl_sag3289'
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'Y'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(18008505657166504395)
,p_name=>'P1_MODE'
,p_item_sequence=>4
,p_item_plug_id=>wwv_flow_api.id(18008501781806504380)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(18008506431070504396)
,p_name=>'P1_MODEL'
,p_item_sequence=>5
,p_item_plug_id=>wwv_flow_api.id(18008501781806504380)
,p_item_default=>'B1'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(18008507250184504396)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(18008508028070504397)
,p_name=>'P1_RETURNFOR'
,p_item_sequence=>7
,p_item_plug_id=>wwv_flow_api.id(18008501781806504380)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(18008508861803504398)
,p_name=>'P1_QUERY'
,p_item_sequence=>8
,p_item_plug_id=>wwv_flow_api.id(18008501781806504380)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(18041779426509080043)
,p_name=>'P1_LOC'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_api.id(18041777006309080019)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(18041776323017080012)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(18041776701452080016)
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(18041779500845080044)
,p_name=>'Location'
,p_event_sequence=>40
,p_triggering_element_type=>'ITEM'
,p_triggering_element=>'P1_LOC'
,p_bind_type=>'bind'
,p_bind_event_type=>'change'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(18041779620007080045)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(18008502894486504386)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_WEB_SERVICE'
,p_process_name=>'Web Service Request'
,p_process_sql_clob=>'15204482540459174765:15204482793129174766'
...
wwv_flow_api.create_web_service(
 p_id=>wwv_flow_api.id(15204482540459174765)
,p_name=>'F15 Rest'
...
wwv_flow_api.create_ws_operations(
 p_id=>wwv_flow_api.id(15204482793129174766)
,p_ws_id=>wwv_flow_api.id(15204482540459174765)
,p_name=>'doREST'
);
wwv_flow_api.create_ws_parameters(
 p_id=>wwv_flow_api.id(15204483082555174767)
...
wwv_flow_api.create_ws_process_parms_map(
 p_id=>wwv_flow_api.id(18008509288438504398)
...
wwv_flow_api.create_ws_parameters(
 p_id=>wwv_flow_api.id(15204741067177356887)
,p_ws_opers_id=>wwv_flow_api.id(15204482793129174766)
,p_name=>'DB'
,p_input_or_output=>'H'
,p_type_is_xsd=>'Y'
...
wwv_flow_api.create_ws_process_parms_map(
 p_id=>wwv_flow_api.id(18008503679239504392)
...
wwv_flow_api.create_ws_parameters(
 p_id=>wwv_flow_api.id(15204741636037356887)
,p_ws_opers_id=>wwv_flow_api.id(15204482793129174766)
,p_name=>'PASS'
,p_input_or_output=>'H'
,p_type_is_xsd=>'Y'
...
wwv_flow_api.create_ws_process_parms_map(
 p_id=>wwv_flow_api.id(18008505203537504395)
...
wwv_flow_api.create_ws_parameters(
 p_id=>wwv_flow_api.id(15204742273712356888)
,p_ws_opers_id=>wwv_flow_api.id(15204482793129174766)
,p_name=>'MODEL'
,p_input_or_output=>'H'
,p_type_is_xsd=>'Y'
...
wwv_flow_api.create_ws_process_parms_map(
 p_id=>wwv_flow_api.id(18008506815320504396)
...
wwv_flow_api.create_ws_process_parms_map(
 p_id=>wwv_flow_api.id(18008507667126504397)
